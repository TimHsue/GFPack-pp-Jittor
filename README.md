...
This repository accompanies the ICCV 2025 paper **GFPack++: Attention-Driven Gradient Fields for Optimizing 2D Irregular Packing** . The code base provides training, evaluation, and sampling utilities for our attention-enhanced score model that learns packing gradients directly from teacher demonstrations. This library is based on the  [Jittor](https://github.com/Jittor/Jittor) version. We also provide pytorch version in [GFPack-pp](https://github.com/TimHsue/GFPack-pp).
